...
ExecutiveCog = '.exe'
ExecutiveCogSuitS = 'executive'
ExecutiveCogSuitP = 'an executive'
...
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.",
 ...
 'MemeSteal': ['Your meme will make a fine addition to my collection.',
               'Oh this is a good one!',
               'Perfect to repost!',
               'I need to send this to the group chat!',
               'What the hell is 0.7V?'],
...
AdvancedResistanceToonName = 'Reggie'
...
AdvancedCashbotBossDiscoverToons2 = 'You thought you could sneak into my vault again toons?'
AdvancedCashbotBossDiscoverToons3 = 'Well I made some upgrades and you are NOT getting out of here smiling this time!'
