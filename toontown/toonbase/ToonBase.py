...
class ToonBase(OTPBase.OTPBase):
    ...
    def setSprinting(self):
        if hasattr(base, 'localAvatar'):
            ...
            base.localAvatar.controlManager.setSpeeds(OTPGlobals.ToonForwardSprintSpeed, OTPGlobals.ToonJumpForce,
                                                      OTPGlobals.ToonReverseSprintSpeed, OTPGlobals.ToonRotateSpeed)
            self.isSprinting = 1
        else:
