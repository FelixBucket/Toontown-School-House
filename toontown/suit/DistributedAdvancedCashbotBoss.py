...
class DistributedAdvancedCashbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedAdvancedCashbotBoss')
    numFakeGoons = 3
    ...
    def __makeResistanceToon(self):
        if self.resistanceToon:
            return
        npc = Toon.Toon()
        npc.setName(TTLocalizer.AdvancedResistanceToonName)
        npc.setPickable(0)
                ...
                Sequence(
                    ...
                    Parallel(
                        ...
                        Parallel(
                            ...
                            Func(self.setChatAbsolute, TTL.AdvancedCashbotBossDiscoverToons2, CFSpeech),
                            Wait(4),
                            Func(self.setChatAbsolute, TTL.AdvancedCashbotBossDiscoverToons3, CFSpeech),
                            Wait(4),
                            Func(self.clearChat),
